...
import { BiChevronRight ,BiSearchAlt2,BiMenu,BiChevronDown, BiShareAlt} from "react-icons/bi";
//context
...
const MovieNavbar=() =>{
    return( <>
        <nav className=" absolute inset-x-0  z-30  bg-opacity-10 backdrop-filter backdrop-blur-lg lg:relative lg:bg-bms-700 p-4"> 
         ...
         <div className="hidden md:block lg:hidden">{/*medium devices/tab screen  */} <NavSm /></div>
